...
public enum EnuActivite {
	 ...
	 */
	private EnuActivite(String value, String libelle) {
		this.value = value;
	 ...
	 * @return
	 */
	public static EnuActivite getByValue(String enumValue) {
		for (EnuActivite enm : EnuActivite.class
				.getEnumConstants()) {
	...
	private static List<EnuActivite> myList;
	...
	public static List<EnuActivite> getListe() {
		return myList;
	}

	static {
		myList = new ArrayList<EnuActivite>();
