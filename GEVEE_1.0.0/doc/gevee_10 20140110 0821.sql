...
INSERT INTO `tab_chau` (`MAT_CHAU`,`BOO_ACT`,`COD_EXE_FIS`,`ETAT_ENT`,`DAT_DEL_CNI`,`DAT_VAL_CNI`,`DAT_VAL_PERM`,`LIB_INF`,`LIB_NOM`,`LIB_PRE`,`LIB_TEL`,`NUM_CNI`,`NUM_PERM`) VALUES 
 ('05Q437','1.00','2014','2000','20060705000000000000','20090114000000000000','20140114000000000000','RAS','Boubakar','Haman','7785412','015487985','000147'),
...
CREATE TABLE `tab_chk` (
  `COD_REF_CHK` varchar(255) NOT NULL default '',
  `BOO_ACT` decimal(19,2) default NULL,
  `COD_EXE_FIS` varchar(255) default NULL,
  `ETAT_ENT` varchar(255) default NULL,
  ...
  `LIB_COM` varchar(45) default NULL,
...
INSERT INTO `tab_chk` (`COD_REF_CHK`,`BOO_ACT`,`COD_EXE_FIS`,`ETAT_ENT`,`BOO_VAL`,`DAT_CHK`,`COD_LIEU`,`COD_REF_MOUV`,`LIB_COM`) VALUES 
 ('CHK_002','1.00','2014','2000',NULL,NULL,'BEP','Mouv_002/Dep001',NULL),
 ('REF001','1.00','2014','2000',NULL,NULL,'EC_PUB','MOUV_001/Dep_001',NULL),
 ('RZEI','1.00','2014','2000',NULL,'20140117000000000000','EC_PUB','Mouv_002/Dep001','RAS'),
 ('TAB','1.00','2014','2000',NULL,NULL,'EC_PUB','Mouv_002/Dep001',NULL),
 ('TREYR','1.00','2014','2000',NULL,'20140110000000000000','PGS','Mouv_002/Dep001',NULL);
...
INSERT INTO `tab_cli` (`COD_CLI`,`BOO_ACT`,`COD_EXE_FIS`,`ETAT_ENT`,`LIB_ADR`,`LIB_FAX`,`LIB_LOC`,`LIB_NOM`,`LIB_PRE`,`LIB_TEL`) VALUES 
 ...
 ('MDIA','1.00','2014','2000','','','','MEDIA MARKET',NULL,'22 33 58 69');
...
INSERT INTO `tab_con` (`COD_CON`,`BOO_ACT`,`COD_EXE_FIS`,`ETAT_ENT`,`ENU_ACO`,`ENU_TYP_CON`,`ENU_TYP_MAR`,`NUM_COM`,`NUM_CON`,`NUM_PLO1`,`NUM_PLO2`,`VAL_POI`,`VAL_VOL`,`NUM_ORD_TRA`) VALUES 
 ...
 ('987TREF/6476_002123','1.00','2013','2006','2006','2000','2001','45NH34','002123','23','32','898','78789.00','987TREF/6476'),
 ('987TREF/6476_0023','1.00','2013','2006','2001','2004','2001','994','0023','3','4','90T63','12.00','987TREF/6476'),
 ('987TREF/6476_89HEG','1.00','2013','2006','2003','2002','2001','87','89HEG','90','35','98','789.00','987TREF/6476'),
 ('ORDTRANS N°0001_001','1.00','2014','2000','2000','2002','2002','001','001','012','485','1200','4510','ORDTRANS N°0001'),
 ('RAS78893_54FD','1.00','2013','2006','2001','2001','2001','4546','54FD','345','54','545','546.00','RAS78893'),
 ('RAS78893_9875RH','1.00','2013','2006','2000','2000','2001','n43','9875RH','45','45','34','545.00','RAS78893');
...
CREATE TABLE `tab_dep` (
  ...
  `DAT_RECEP` varchar(45) default NULL,
  `BOO_REL_VID` decimal(1,0) default NULL,
...
INSERT INTO `tab_dep` (`COD_REF_DEP`,`BOO_ACT`,`COD_EXE_FIS`,`ETAT_ENT`,`BOO_CAU`,`BOO_CLO`,`BOO_DEM`,`BOO_RECEP`,`DAT_EFF_DECHA`,`DAT_EFF_ENLEV`,`DAT_EFF_RET`,`DAT_EST_RET`,`DAT_REL_VID`,`LIB_ADD_RECEP`,`LIB_RECEP`,`VAL_CAU`,`VAL_DET`,`COD_CON`,`DAT_RECEP`,`BOO_REL_VID`) VALUES 
 ('DEP001','1.00','2014','2006','0.00',NULL,'1.00','1.00',NULL,'20140108000000000000',NULL,'20140116000000000000',NULL,NULL,NULL,NULL,NULL,'RAS78893_54FD',NULL,NULL),
 ('DEP005','1.00','2014','2006','0.00',NULL,NULL,'1.00',NULL,'20140116000000000000',NULL,'20140115000000000000',NULL,NULL,NULL,NULL,NULL,'RAS78893_54FD',NULL,NULL),
 ('Dep_001','1.00','2014','2003','1.00',NULL,'1.00',NULL,NULL,'20140109000000000000',NULL,'20140111000000000000',NULL,NULL,NULL,'800000.00',NULL,'ORDTRANS N°0001_001',NULL,NULL);
...
INSERT INTO `tab_lieu` (`COD_LIEU`,`BOO_ACT`,`COD_EXE_FIS`,`ETAT_ENT`,`LIB_LIEU`) VALUES 
 ('BEP','1.00','2014','2000','Bepanda axe lourd'),
 ('DIT','1.00','2013','2000','Douala International Terminal'),
 ('EC_PUB','1.00','2014','2000','Ecole publique'),
 ('MBA','1.00','2014','2000','MBADJOCK'),
 ('PARC09092','1.00','2013','2000','Parc à vide Armateur'),
 ('PGS','1.00','2014','2000','Parc GS');
...
INSERT INTO `tab_mouv` (`COD_REF_MOUV`,`BOO_ACT`,`COD_EXE_FIS`,`ETAT_ENT`,`BOO_VAL`,`DAT_ARRIV`,`DAT_DEPAR`,`ENU_ETAT_CON`,`ENU_SENS_MOUV`,`ENU_TYP_MOUV`,`HEUR_ARRIV`,`HEUR_DEPAR`,`POS_MOUV`,`COD_CHAU`,`COD_REF_DEP`,`COD_LIEU_ARRIV`,`COD_LIEU_DEPAR`,`COD_REM`,`COD_TRAC`) VALUES 
 ('Mouv001','1.00','2014','2002','1.00','20140117000000000000','20140109000000000000','02','01','06','Thu Jan 01 18:45:00 WAT 1970','Thu Jan 01 13:45:00 WAT 1970',1,'657BZF','DEP001','MBA','DIT','REM02','TRA02'),
 ('MOUV002','1.00','2014','2002','1.00','20140113000000000000','20140108000000000000','01','02','03','Thu Jan 01 13:10:00 WAT 1970','Thu Jan 01 15:45:00 WAT 1970',2,'657BZF','DEP001','PARC09092','MBA','REM03','TRA01'),
 ('Mouv006','1.00','2014','2002','1.00','20140122000000000000','20140115000000000000','01','02','04','Thu Jan 01 19:42:00 WAT 1970','Thu Jan 01 13:56:00 WAT 1970',3,'05S024','DEP001','DIT','PARC09092','REM02','TRA02'),
 ('Mouv12','1.00','2014','2002','1.00','20140114000000000000','20140108000000000000','02','02','03','Thu Jan 01 14:56:00 WAT 1970','Thu Jan 01 13:23:00 WAT 1970',4,'657BZF','DEP001','PARC09092','DIT','REM03','TRA01'),
 ('Mouv2013','1.00','2014','2000',NULL,'20140110000000000000','20140109000000000000','02','01','06','Thu Jan 01 14:45:00 GMT+01:00 1970','Thu Jan 01 13:23:00 GMT+01:00 1970',3,'05S024','Dep_001','PGS','MBA','REM02','TRA02');
INSERT INTO `tab_mouv` (`COD_REF_MOUV`,`BOO_ACT`,`COD_EXE_FIS`,`ETAT_ENT`,`BOO_VAL`,`DAT_ARRIV`,`DAT_DEPAR`,`ENU_ETAT_CON`,`ENU_SENS_MOUV`,`ENU_TYP_MOUV`,`HEUR_ARRIV`,`HEUR_DEPAR`,`POS_MOUV`,`COD_CHAU`,`COD_REF_DEP`,`COD_LIEU_ARRIV`,`COD_LIEU_DEPAR`,`COD_REM`,`COD_TRAC`) VALUES 
 ('MOUV_001/Dep_001','1.00','2014','2002','1.00','20140109000000000000','20140109000000000000','02','01','02','Thu Jan 01 15:18:00 WAT 1970','Thu Jan 01 11:32:00 WAT 1970',1,'05Q437','Dep_001','PGS','DIT','REM01','TRA02'),
 ('Mouv_002/Dep001','1.00','2014','2002','1.00','20140110000000000000','20140110000000000000','02','01','02','Thu Jan 01 16:56:00 WAT 1970','Thu Jan 01 11:30:00 WAT 1970',2,'05Q437','Dep_001','BEP','PGS','REM02','TRA02');
...
INSERT INTO `tab_ord` (`NUM_ORD_TRA`,`BOO_ACT`,`COD_EXE_FIS`,`ETAT_ENT`,`BOO_CLO`,`DAT_DECHA`,`DAT_ENLEV`,`ENU_ACT`,`LIB_OBS`,`NUM_DOSS`,`VAL_COL_TOT`,`VAL_POI_TOT`,`COD_CLI`,`COD_LIEU_DECHA`,`COD_LIEU_ENLEV`) VALUES 
 ...
 ('ORDTRANS N°0001','1.00','2014','2000',NULL,'20140110000000000000','20140109000000000000','01','RAS','ORDTRANS N°0001/01/2014','2.00','6789T09','MDIA','BEP','DIT'),
